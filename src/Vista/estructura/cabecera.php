...
<header class="container-fluid m-0 p-0">
        <nav class="container-fluid fs-3 bg-naranja p-4">
            <div class="container-sm d-flex justify-content-between">
                <div class="w100-h55">
                    <a href="../../../../TpFinal-TiendaZapatillas/index.php"><img src="../../../../TpFinal-TiendaZapatillas/src/Vista/Assets/imgs/th.jpg" alt="" class="h-100 w-100 objet-fit rounded"></a>    
                </div>
                <div class="d-flex">
                    <div>
                    ...
                    <div class="w-h">
                        <img src="../../../../TpFinal-TiendaZapatillas/src/Vista/Assets/imgs/carrito.svg" alt="" class="w100-h55">                    
                    </div>
                </div>
            </div>
        </nav>
